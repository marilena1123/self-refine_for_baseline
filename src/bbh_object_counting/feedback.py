...
class BBHObjectCountingFeedback(Prompt):
    def __init__(self, engine: str, prompt_examples: str, temperature: float, max_tokens: int = 600) -> None:
        ...
        self.instruction = "There is an error in the answer above because of a misunderstanding of the question. What is the error? To find the error, go through the list of items step by step and check if everything looks good."
...
def test():
    task_fb = BBHObjectCountingFeedback(
