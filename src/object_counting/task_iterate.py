...
class ObjectCountingTaskIterate(Prompt):
    ...
    def make_one_iterate_example(self, incrementally_improving_examples: list) -> str:
        instr = """We want to iteratively improve counting answers. Scores on three dimensions are provided: i) identification accuracy, ii) quantity handling, iii) answer correctness.
