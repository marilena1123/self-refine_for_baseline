...
def extract_option(text: str):
    """Extract the selected option (A) or (B) from a generated answer."""
    match = re.search(r"\(([AB])\)", str(text))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate snarks self-refine output")
    parser.add_argument("--path", type=str, default="data/tasks/snarks/output.jsonl")
