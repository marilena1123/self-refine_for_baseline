...
if __name__ == "__main__":
    ...
    parser.add_argument("--task_file", type=str, default="data/tasks/bbh_disambiguation/data.jsonl")
    parser.add_argument("--max_attempts", type=int, default=4)
    parser.add_argument("--outfile", type=str, default="outputs/bbh_disambiguation_results.jsonl")
