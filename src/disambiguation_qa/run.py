...
def iterative_disambiguation_qa(input_text: str, max_attempts: int) -> dict:
...
def run_over_data(input_file: str, max_attempts: int, outfile: str):
    def _parse_results(input_text: str) -> str:
        try:
            results = iterative_disambiguation_qa(
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 2:
        ...
        max_attempts = 5
        all_answers_to_scores = iterative_disambiguation_qa(
