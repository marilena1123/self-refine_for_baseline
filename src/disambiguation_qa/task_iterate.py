...
class DisambiguationQATaskIterate(Prompt):
    ...
    def make_one_iterate_example(self, incrementally_improving_examples: list) -> str:
        instr = """We want to iteratively improve pronoun disambiguation answers. Scores on two dimensions are provided: i) reasoning quality, ii) answer correctness.
...
* Reasoning quality: {reasoning_score}
...
if __name__ == "__main__":
    obj = DisambiguationQATaskIterate(
        prompt_examples="data/prompt/disambiguation_qa/feedback.jsonl",
